...
var SearchPlayerComponent = /** @class */ (function () {
    ...
    SearchPlayerComponent.prototype.onKeydown = function (event) {
        if (event.key === "Enter") {
            this.searchPlayer();
        }
    };
...
module.exports = __webpack_require__(/*! d:\Academias\UAB\Automatizacion de Pruebas\Proyecto\test-pyramid\src\front-end\src\main.ts */"./src/main.ts");
